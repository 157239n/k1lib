...
class ModuleSelector:
    ...
    def __init__(self, parent:"ModuleSelector", name:str, nnModule:nn.Module):
...
Default is just::
    ...
    def highlight(self, prop:str):
        self.displayF = lambda self: (k1lib.format.red if self.selected(prop) else k1lib.format.identity)(', '.join(self.selectedProps))
        return self
    ...
    def named_modules(self, prop:str=None) -> Iterator[Tuple[str, nn.Module]]:
...
:param prop: Filter property"""
    ...
    def modules(self, prop:str=None) -> Iterator[nn.Module]:
