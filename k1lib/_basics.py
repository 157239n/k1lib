...
import logging, warnings, os, time, re, gc, json, k1lib, importlib, urllib.parse, math, base64, dill, inspect, asyncio, signal
...
"""                                                                              # patch
    ...
    return inner                                                                 # patch
shutdownEvent = threading.Event()                                                # patch
def handle_sigint(signum, frame): print("\nSIGINT received. Stopping crons..."); shutdownEvent.set() # handle_sigint
signal.signal(signal.SIGINT, handle_sigint)                                      # handle_sigint
