...
See also: :class:`~k1lib.selector.ModuleSelector`"""
    ...
    def _warnings(self):
        ...
        warnings += "Warning: no loss function callback detected (or you set `lossF` already but then erased all callbacks)! Set using `l.lossF = ...` or `l.cbs.withLossF(...)`\n" if len(lossFnCbs) == 0 else ""
