...
import random, math, sys, io, os, numpy as np, functools, time, traceback, threading, struct, json, pprint
plt = k1lib.dep.plt
...
class AutoIncrement:                                                             # AutoIncrement
    def __init__(self, initialValue:int=-1, n:int=float("inf"), prefix:str=None, unique=False): # AutoIncrement
...
There's also the .unique param. Here's how it works::

    a = AutoIncrement(n=4, unique=True);
    [a(), a(), a()]         # returns [0, 1, 2]
    a.remove(2); [a(), a()] # returns [3, 2]
    a() # raises error, as there's no number left between 0 and 4
...
:param unique: if True, and .n is specified, will throw an error if a number
    is used that isn't freed with .remove() yet"""                               # AutoIncrement
        self._value = initialValue; self.n = n; self.prefix = prefix; self.unique = unique; self.currentValues = [] # AutoIncrement
    ...
    def __call__(self):                                                          # AutoIncrement
        ...
        if self.unique:                                                          # AutoIncrement
            currentValues = self.currentValues; maxValue = self.n; i = self._value # AutoIncrement
            if len(currentValues) == maxValue: raise Exception("Ran out of elements to yield") # AutoIncrement
            while True:                                                          # AutoIncrement
                i = (i+1) % maxValue                                             # AutoIncrement
                if i not in currentValues: currentValues.append(i); self._value = i; return i # AutoIncrement
        else:                                                                    # AutoIncrement
            self._value += 1                                                     # AutoIncrement
            if self._value >= self.n: self._value = 0                            # AutoIncrement
            return self.value                                                    # AutoIncrement
    def remove(self, k): self.currentValues.remove(k)                            # AutoIncrement
    @staticmethod                                                                # AutoIncrement
...
relatively good."""                                                              # Icon
    ...
    @staticmethod                                                                # Icon
    def calendar(fill=None, size=None): return f'<svg xmlns="http://www.w3.org/2000/svg" height="{size or iS.size}px" viewBox="0 -960 960 960" width="{size or iS.size}px" fill="{fill or iS.fill}"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Zm0-480h560v-80H200v80Zm0 0v-80 80Z"/></svg>' # Icon
    @staticmethod                                                                # Icon
    def keyboard(fill=None, size=None): return f'<svg xmlns="http://www.w3.org/2000/svg" height="{size or iS.size}px" viewBox="0 -960 960 960" width="{size or iS.size}px" fill="{fill or iS.fill}"><path d="M160-200q-33 0-56.5-23.5T80-280v-400q0-33 23.5-56.5T160-760h640q33 0 56.5 23.5T880-680v400q0 33-23.5 56.5T800-200H160Zm0-80h640v-400H160v400Zm160-40h320v-80H320v80ZM200-440h80v-80h-80v80Zm120 0h80v-80h-80v80Zm120 0h80v-80h-80v80Zm120 0h80v-80h-80v80Zm120 0h80v-80h-80v80ZM200-560h80v-80h-80v80Zm120 0h80v-80h-80v80Zm120 0h80v-80h-80v80Zm120 0h80v-80h-80v80Zm120 0h80v-80h-80v80ZM160-280v-400 400Z"/></svg>' # Icon
    @staticmethod                                                                # Icon
    def archive(fill=None, size=None): return f'<svg xmlns="http://www.w3.org/2000/svg" height="{size or iS.size}px" viewBox="0 -960 960 960" width="{size or iS.size}px" fill="{fill or iS.fill}"><path d="m480-240 160-160-56-56-64 64v-168h-80v168l-64-64-56 56 160 160ZM200-640v440h560v-440H200Zm0 520q-33 0-56.5-23.5T120-200v-499q0-14 4.5-27t13.5-24l50-61q11-14 27.5-21.5T250-840h460q18 0 34.5 7.5T772-811l50 61q9 11 13.5 24t4.5 27v499q0 33-23.5 56.5T760-120H200Zm16-600h528l-34-40H250l-34 40Zm264 300Z"/></svg>' # Icon
    @staticmethod                                                                # Icon
    def unarchive(fill=None, size=None): return f'<svg xmlns="http://www.w3.org/2000/svg" height="{size or iS.size}px" viewBox="0 -960 960 960" width="{size or iS.size}px" fill="{fill or iS.fill}"><path d="M480-560 320-400l56 56 64-64v168h80v-168l64 64 56-56-160-160Zm-280-80v440h560v-440H200Zm0 520q-33 0-56.5-23.5T120-200v-499q0-14 4.5-27t13.5-24l50-61q11-14 27.5-21.5T250-840h460q18 0 34.5 7.5T772-811l50 61q9 11 13.5 24t4.5 27v499q0 33-23.5 56.5T760-120H200Zm16-600h528l-34-40H250l-34 40Zm264 300Z"/></svg>' # Icon
    @staticmethod                                                                # Icon
    def apps(fill=None, size=None): return f'<svg xmlns="http://www.w3.org/2000/svg" height="{size or iS.size}px" viewBox="0 -960 960 960" width="{size or iS.size}px" fill="{fill or iS.fill}"><path d="M183.5-183.5Q160-207 160-240t23.5-56.5Q207-320 240-320t56.5 23.5Q320-273 320-240t-23.5 56.5Q273-160 240-160t-56.5-23.5Zm240 0Q400-207 400-240t23.5-56.5Q447-320 480-320t56.5 23.5Q560-273 560-240t-23.5 56.5Q513-160 480-160t-56.5-23.5Zm240 0Q640-207 640-240t23.5-56.5Q687-320 720-320t56.5 23.5Q800-273 800-240t-23.5 56.5Q753-160 720-160t-56.5-23.5Zm-480-240Q160-447 160-480t23.5-56.5Q207-560 240-560t56.5 23.5Q320-513 320-480t-23.5 56.5Q273-400 240-400t-56.5-23.5Zm240 0Q400-447 400-480t23.5-56.5Q447-560 480-560t56.5 23.5Q560-513 560-480t-23.5 56.5Q513-400 480-400t-56.5-23.5Zm240 0Q640-447 640-480t23.5-56.5Q687-560 720-560t56.5 23.5Q800-513 800-480t-23.5 56.5Q753-400 720-400t-56.5-23.5Zm-480-240Q160-687 160-720t23.5-56.5Q207-800 240-800t56.5 23.5Q320-753 320-720t-23.5 56.5Q273-640 240-640t-56.5-23.5Zm240 0Q400-687 400-720t23.5-56.5Q447-800 480-800t56.5 23.5Q560-753 560-720t-23.5 56.5Q513-640 480-640t-56.5-23.5Zm240 0Q640-687 640-720t23.5-56.5Q687-800 720-800t56.5 23.5Q800-753 800-720t-23.5 56.5Q753-640 720-640t-56.5-23.5Z"/></svg>' # Icon
    @staticmethod                                                                # Icon
...
You can also nest structs inside one another::
...
Finally, you can also have arrays::

    sDef = {"a": ["u8", 5], "b": (["f32", 3], "some random desc, for html view")}; s = k1.Struct(sDef)
    s.a[1] = 23; s.b[2] = 3.5; s._values() # returns {'a': [0, 23, 0, 0, 0], 'b': [0, 0, 3.5]}

This mechanism is also available on JS side, see :meth:`_js`

:param structDef: struct definition
:param strict: whether to raise error when parsing bytes with lower length than the struct
...
and provides callback functions to send the bytes to other places. Example::
    ...
    htm = s._toHtml("pre1"); (k1.Struct._html() + htm) | toHtml() # first time using the html, have to include k1.Struct._html()

    htm | toHtml() # after using it the first time, subsequent times don't have to include k1.Struct._html() (includes k1.Struct._js() and k1.Struct._styles())
